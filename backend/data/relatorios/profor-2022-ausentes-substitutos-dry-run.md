...
Nenhum vínculo sugerido nesta execução.

## Detalhe por divergência ausente
...
| #75 | 937782 | `CORRIGIDO` | **ja_decidido** | — | Divergência já possui decisão resolutiva (CORRIGIDO). |
| #76 | 937782 | `CORRIGIDO` | **ja_decidido** | — | Divergência já possui decisão resolutiva (CORRIGIDO). |
| #77 | 937782 | `CORRIGIDO` | **ja_decidido** | — | Divergência já possui decisão resolutiva (CORRIGIDO). |
| #78 | 937782 | `CORRIGIDO` | **ja_decidido** | — | Divergência já possui decisão resolutiva (CORRIGIDO). |
