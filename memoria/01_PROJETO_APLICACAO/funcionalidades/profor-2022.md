...
1. Criar tabela SQLite de convênios monitorados.
2. Criar serviço backend da carteira.
3. Criar rotas locais da carteira.
4. Criar importação inicial da carteira a partir da aba `Geral`.
5. Criar interface ou modal para cadastrar novo convênio.
6. Criar leitor do `siconv_convenio.csv.zip`.
