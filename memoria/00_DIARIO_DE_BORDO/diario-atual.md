...
- Resiliência da fila: o input `timeout` de `actions/deploy-pages@v5` foi ampliado para `3.600.000 ms` (60 minutos). A alteração não muda o artefato nem o conteúdo publicado; apenas impede cancelamento prematuro durante latência excepcional do serviço Pages.
